...
2. If there is a light blue **pause** icon next to your Team  Master then it is hibernating. Just click on the link for your Team Master to **un-hibernate** it. <p><img src="https://github.com/cloudbees-days/core-rollout-flow-workshop/raw/master/labs/hibernating-masters/images/hibernating-master.png" width=800/>
3. Once you click on your Team Master link from the classic UI of Operations Center you will see a screen that shows that it is "getting ready to work". <p><img src="https://github.com/cloudbees-days/core-rollout-flow-workshop/raw/master/labs/hibernating-masters/images/unhibernate.png" width=800/>
