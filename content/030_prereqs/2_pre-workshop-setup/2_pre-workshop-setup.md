...
1. Ensure that you are logged into GitHub.com and then navigate to [https://github.com/apps/cloudbees-ci-workshop-in-aws](https://github.com/apps/cloudbees-ci-workshop-in-aws).<p>![GitHub App](cbci-github-app.png?width=60pc)
