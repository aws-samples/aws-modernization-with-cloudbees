...
aws cloudformation create-stack --stack-name Cloudbees-Workshop --template-body file://cloudfront-s3-website.yaml
```
...
```
### DO NOT FORGET TO CHANGE THE STACK NAME
aws cloudformation create-stack --stack-name Cloudbees-Website-Pipeline --template-body file://pipeline.yaml --capabilities CAPABILITY_NAMED_IAM
```
